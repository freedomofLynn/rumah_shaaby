...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="/login" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        id="email"  value="{{ old('email') }}" placeholder="{{ __('Email Address') }}" required
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {{-- <div class="input-group input-group-merge form-password-toggle"> --}}
                                            ...
                                            {{-- @error('password') is-invalid @enderror" id="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
    ...
    <script src="{{asset('')}}rumah_shaaby/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('')}}rumah_shaaby/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
